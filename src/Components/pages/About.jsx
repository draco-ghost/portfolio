          ...
          <div className='cont-content relative z-10 w-full lg:w-[60%] lg:h-fit lg:p-4 text-center lg:ml-5 flex flex-col 
            ...
            <div className='pt-4 pb-4'>
              <div>
                ...
                <div className='px-1 lg:px-8 3lg:text-2xl font-bold'>
              ...
              <div className='py-4 w-full h-full p-2 3lg:text-2xl'>
                <div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 3xl:grid-cols-3 4xl:grid-cols-4 gap-4 lg:overflow-hidden lg:overflow-y-auto'>
