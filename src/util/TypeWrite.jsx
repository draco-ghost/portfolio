...
export default function TypeWrite() {
    ...
    return (
        <p className='border-b rounded-3xl p-[2px_10px] w-fit place-self-center shadow-xl shadow-green-900 hover:shadow-pink-600 hover:text-pink-600 cursor-pointer'>
            {text}
